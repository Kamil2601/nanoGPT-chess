...
# Lista plików CSV
input_files = [
    f"../data/csv/elo_split/elo_{elo}-{elo+99}.csv"
    for elo in range(lowest_elo, highest_elo + 1, 100)
]


# Ile wierszy brać z KAŻDEGO pliku
train_size_per_file = 200_000
val_size_per_file = 2_000
test_size_per_file = 2_000
min_game_ply = 4

# Folder wyjściowy
output_dir = "../data/csv/train_val_test"
...
for file_path in input_files:
    ...
    df = pd.read_csv(
        file_path, nrows=total_needed, dtype={"white_title": str, "black_title": str}
    )
