...
tensorboard_logger_name = "elo_training"
checkpoint_path = "./models/elo_training/"
...
tensorboard_logger = pl.loggers.TensorBoardLogger(save_dir="./lightning_logs/elo_training", name=tensorboard_logger_name)
